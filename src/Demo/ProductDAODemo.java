...
public class ProductDAODemo extends ProductDAO {
    ...
    public void initData() {
        database.insertTable(NAME_PRODUCT, new Product(1, "CPU", 750, 10, 1));
        database.insertTable(NAME_PRODUCT,new Product(2, "RAM", 50, 2, 2));
        database.insertTable(NAME_PRODUCT,new Product(3, "HDD", 70, 1, 2));
        database.insertTable(NAME_PRODUCT,new Product(4, "Main", 400, 3, 1));
        database.insertTable(NAME_PRODUCT,new Product(5, "Keyboard", 30, 8, 4));
        database.insertTable(NAME_PRODUCT,new Product(6, "Mouse", 25, 50, 4));
        database.insertTable(NAME_PRODUCT,new Product(7, "VGA", 60, 35, 3));
        database.insertTable(NAME_PRODUCT,new Product(8, "Monitor", 120, 28, 2));
        database.insertTable(NAME_PRODUCT,new Product(9, "Case", 120, 28, 5));
    }
